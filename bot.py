...
def main():
    ...
    app.add_handler(CommandHandler(["помощь", "help"], cmd_help))
    app.add_handler(CommandHandler(["задачи", "tasks"], cmd_my_tasks))
    app.add_handler(CommandHandler(["все_задачи", "all_tasks"], cmd_all_tasks))
    app.add_handler(CommandHandler(["просрочка", "overdue"], cmd_overdue))
    app.add_handler(CommandHandler(["отчет", "report"], cmd_report))
    app.add_handler(CommandHandler(["дебиторка", "debts"], cmd_debtors))
    app.add_handler(CommandHandler(["фото", "photo"], cmd_photo))
    app.add_handler(CommandHandler(["прайс", "price"], cmd_price))
    app.add_handler(CommandHandler(["контакт", "contact"], cmd_contact))
