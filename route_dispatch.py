...
# 8267564735 — Белякова. Петровский В. снят с логистики 07.09.2026 (ушёл
# учётчиком партий в цех) — его id убран из дефолта. Список — env
# LOGIST_CHAT_IDS (через запятую); добавить логиста = дописать id.
