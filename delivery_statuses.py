...
проставляет статус отгрузки в МойСклад:
  ...
  - «Задержка в пути»   — по РЕАЛЬНОМУ окну приёмки, в двух случаях:
                          ...
                          (Белякова)+Маланчук (одно на машину за прогон,
...
# 26695 (Е 898 СР, Ларгус) — трекер с 17.09.2026, ночёвки 17–21.09 по треку: Люберцы,
# ул С.П.Попова 46 (та же стоянка, что у КИА) и ул 65 лет Победы 1к18.
HOME_POINTS = {
    26209: [(55.9033, 37.4062), (55.69755, 37.90371)],
    26695: [(55.69762, 37.90345), (55.68441, 37.88906)],
}
R_HOME_M = 300
