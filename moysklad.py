...
# Клиенты, ИСКЛЮЧЁННЫЕ из штрафа по дебиторке (штрафы включены с 2026-07).
# На дашборде показываем блёкло и НЕ считаем в штраф (суд / особые отношения).
# Ключ — agent_id МС (стабильный). Добавление/удаление — правка этого списка.
PDZ_PENALTY_EXCLUDE = {
    "e6e3acdc-a11d-11f0-0a80-056600237524": "НП КОРОЛЕВ / Мерзлякова",
    "136b0279-dcbb-11f0-0a80-0d130009106c": "ЯПОША ГРУПП / Мерзлякова",
    "e8732b6b-a11d-11f0-0a80-0566002376f0": "Павлова / Мерзлякова",
    "e600c246-a11d-11f0-0a80-0566002373fd": "ДЖИ ЭФ СИ / Инесса",
    "e62e1105-a11d-11f0-0a80-05660023743f": "КОРОЛЕВСКИЙ РАЦИОН / Карина",
}
