...
# Группа по умолчанию — «F2B ПРОИЗВОДСТВО». Переезд в отдельную группу = смена env.
DEFAULT_CHAT_ID = -1002460651890
...
WORKDAYS = {int(x) for x in os.getenv("QC_WORKDAYS", "0,1,2,3,4").split(",") if x.strip()}
