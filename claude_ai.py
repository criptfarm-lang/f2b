...
- get_overdue: просроченная дебиторка — все или по группе/менеджеру (параметр: tag, опционально)
...
Ответ: {{"action": "get_overdue", "params": {{}}, "confidence": 0.98}}

Запрос: "просрочка по Скляр"
Ответ: {{"action": "get_overdue", "params": {{"tag": "скляр"}}, "confidence": 0.97}}

Запрос: "кто из хореки просрочил оплату?"
Ответ: {{"action": "get_overdue", "params": {{"tag": "хорека"}}, "confidence": 0.96}}

Запрос: "есть просроченная задолженность у Биг Мама?"
Ответ: {{"action": "get_overdue", "params": {{"query": "Биг Мама"}}, "confidence": 0.97}}

Запрос: "просрочка по Атмосфера"
Ответ: {{"action": "get_overdue", "params": {{"query": "Атмосфера"}}, "confidence": 0.97}}

Запрос: "Белуга просрочила?"
Ответ: {{"action": "get_overdue", "params": {{"query": "Белуга"}}, "confidence": 0.95}}
