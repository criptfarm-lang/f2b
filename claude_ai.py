...
- broadcast: разослать сообщение клиентам которые покупали определённый товар (параметры: product — название товара, message — текст сообщения)
...
Запрос: "разошли предложение на дорадо всем кто покупал: Дорадо 300-400 по спеццене 890 руб!"
Ответ: {{"action": "broadcast", "params": {{"product": "дорадо", "message": "Дорадо 300-400 по спеццене 890 руб!"}}, "confidence": 0.99}}

Запрос: "разошли всем клиентам по форели: Форель доступна по цене 650 руб/кг"
Ответ: {{"action": "broadcast", "params": {{"product": "форель", "message": "Форель доступна по цене 650 руб/кг"}}, "confidence": 0.99}}
