...
Согласованная цена действует на один заказ в течение 5 дней (решение собственника 22.09.2026: «14 дней долго, 5 дней максимум»).
"""
...
def apply_dashboard_approvals(price: dict, order_name: str) -> dict:
    ...
    согласование ещё действует (5 дней) и не использовано в другом заказе.
